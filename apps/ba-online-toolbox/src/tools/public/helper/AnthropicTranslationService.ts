...
function getClaudeTranslation(
  ...
  if (temperature >= 0.33) {
    sft_request.system[0].text +=
      "你可以改写大量原句结构以追求通顺和符合原文语气。";
  } else if (temperature >= 0.66) {
    sft_request.system[0].text +=
      "你可以改变些许原句结构以追求通顺和符合原文语气。";
  } else {
